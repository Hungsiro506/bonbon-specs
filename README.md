...
**[`COVERAGE.md`](./COVERAGE.md)** cross-references every AC/FR in this repo with the scenarios in [bonbon](https://github.com/Hungsiro506/bonbon)/e2e that link to it. Uncovered IDs are flagged ⚠️. This file is auto-generated by bonbon's [`publish-coverage-matrix` workflow](https://github.com/Hungsiro506/bonbon/blob/main/.github/workflows/publish-coverage-matrix.yml) on every merge to main — PM and QA get a single-pane-of-glass view of test coverage per spec.
